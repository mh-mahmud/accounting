                        ...
                        <div class="row-fluid">
                            ...
                            <div class="block">
                                <div class="navbar navbar-inner block-header">
                                    <div class="muted pull-left">Create Debit Voucher</div>
                                </div>
                                    ...
                                    <form method="post" action=""  enctype="multipart/form-data" id="" class="form-horizontal">
                                        ...
                                        <fieldset>
                                                  ...
                                                  <div class="col-md-12 my_real_div">
                                                        ...
                                                        <div class="form-group" >
                                                          <label for="exampleInputEmail1">Debit<span class="required">*</span></label>
                                                              <select class="span12 m-wrap" name="debit[]">
                                                                ...
                                                                <?php
                                                                  $options = $this->db->query("SELECT * FROM account_name WHERE GROUP_HEAD_NAME <>'' AND GROUP_HEAD_NAME IN ('Expense')")->result();
                                                                ?>
                                                    ...
                                                    <div class="span2 my_span">
                                                        <div class="form-group" >
                                                          ...
                                                          <textarea rows="1" name="description[]" class="span12 m-wrap" ><?php echo set_value('description',$edit['DESCRIPTION']); ?></textarea>
                                                      ...
                                                      <div class="form-group" >
                                                        <label for="exampleInputEmail1">Debit<span class="required">*</span></label>
                                                            <select class="span12 m-wrap" name="debit[]">
                                                              <option value="">Select...</option>
                                                              <?php
                                                                $options = $this->db->query("SELECT * FROM account_name WHERE GROUP_HEAD_NAME <>'' AND GROUP_HEAD_NAME IN ('Asset', 'Expense')")->result();
                                                              ?>
                                                              <?php foreach($options as $option) : ?>
                                                                <option value="<?php echo $option->CODE?>" 
                                              ...
                                              <div class="control-group">
                                                  ...
                                                  <div class="col-md-12 my_real_div">
                                                    ...
                                                    <div class="span2">
                                                      <div class="form-group">
                                                        <label>Amount<span class="required">*</span></label>
                                                              <input type="text" name="credit_amount" data-required="1" class="span12 m-wrap" value="<?php echo set_value('credit_amount'); ?>" />
                                                    ...
                                                    <div class="span2 my_span">
                                                        <div class="form-group" >
                                                          <label for="exampleInputEmail1">Narration<span class="required">*</span></label>
                                                          <textarea rows="1" name="credit_description" class="span12 m-wrap" ><?php echo set_value('credit_description'); ?></textarea>
                                                          <span class="fred"><?php echo form_error('credit_description'); ?></span>
                                                        </div>
                                                    </div>
                                                  </div>
                                          ...
                                          <div class="control-group">
                                              ...
                                              <div class="controls">
                                                  <input type="text" name="paid_to" data-required="1" class="span6 m-wrap" value="<?php echo set_value('paid_to',$edit['PAID_TO']); ?>" />
                                                  <span class="fred"><?php echo form_error('paid_to'); ?></span>
                                              </div>
                                          </div>
