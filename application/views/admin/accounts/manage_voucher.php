                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Manage Debit Voucher</div>
                            </div>
                                            ...
                                            ?>
                                              <tr class="odd gradeX">
                                                  ...
                                                  <td>
                                                    ...
                                                    <?php if( $this->webspice->permission_verify('manage_voucher',true)): ?>
                                                        <a href="<?php echo $url_prefix; ?>manage_voucher/debit_voucher/<?php echo $this->webspice->encrypt_decrypt($v->VOUCHER_NO,'encrypt'); ?>" class="btn btn-info">Details</a>
                                                    <?php endif; ?>
